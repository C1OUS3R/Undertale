...
execute if score @s stage matches 1 if score @s continue matches 1.. if score @s selected matches 1..2 scheduled 1t run function boss:display/stage2
...
execute if score @s stage matches 1 if score @s continue matches 1.. if score @s selected matches 3 if score @s itemCount matches 1.. scheduled 1t run function boss:display/item
execute if score @s stage matches 1 if score @s continue matches 1.. if score @s selected matches 4 scheduled 1t run function boss:display/stage3