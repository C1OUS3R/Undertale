...
execute scheduled 10 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack11","attack-.5","toriel","bounce"]} 28.0 35 -63.0 0 0 0 true
execute scheduled 13 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack12","attack-.5","toriel","bounce"]} 27.0 35 -62.9 0 0 0 true
execute scheduled 16 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack13","attack-.5","toriel","bounce"]} 26.0 35 -62.8 0 0 0 true
execute scheduled 19 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack14","attack-.5","toriel","bounce"]} 25.0 35 -62.5 0 0 0 true
execute scheduled 22 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack15","attack-.5","toriel","bounce"]} 24.0 35 -62.3 0 0 0 true
execute scheduled 25 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack16","attack-.5","toriel","bounce"]} 23.0 35 -62.1 0 0 0 true
execute scheduled 28 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack17","attack-.5","toriel","bounce"]} 22.0 35 -62.4 0 0 0 true
execute scheduled 31 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack18","attack-.5","toriel","bounce"]} 21.0 35 -62.7 0 0 0 true
execute scheduled 34 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5062}},Tags:["attack","attack19","attack-.5","toriel","bounce"]} 20.0 35 -63.0 0 0 0 true
...
execute scheduled 70 run execute as @e[tag=attack11] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 73 run execute as @e[tag=attack12] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 76 run execute as @e[tag=attack13] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 79 run execute as @e[tag=attack14] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 82 run execute as @e[tag=attack15] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 85 run execute as @e[tag=attack16] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 88 run execute as @e[tag=attack17] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 91 run execute as @e[tag=attack18] at @p run velocity @s toPos ~ 35 ~ .3
execute scheduled 94 run execute as @e[tag=attack19] at @p run velocity @s toPos ~ 35 ~ .3
