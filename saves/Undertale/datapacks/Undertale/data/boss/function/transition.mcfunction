...
scoreboard players set #fleefromtoriel data 0
...
execute scheduled 10t run function boss:attacks/player/attack_health_calc
...
execute scheduled 11t run function boss:display/enemy_health

textBox style 695700113 box margin right 50
textBox style 695700213 box margin right 50
textBox style 695700313 box margin right 50

textBox style 695700114 box margin right 50
textBox style 695700214 box margin right 50
textBox style 695700314 box margin right 50

textBox style 695700115 box margin right 50
textBox style 695700116 box margin right 50
textBox style 695700215 box margin right 50
textBox style 695700216 box margin right 50
textBox style 695700315 box margin right 50
textBox style 695700316 box margin right 50
...
execute scheduled 12t run function boss:display/arrow

execute scheduled 13t run textBox display @s 585700100 [{"nbt":"StartDisplay1-1[]","storage":"encounter","interpret":true,"font":"customfonts:determination"},{"text": "\n"},{"nbt":"StartDisplay1-2[]","storage":"encounter","interpret":true,"font":"customfonts:determination"},{"text": "\n"},{"nbt":"StartDisplay1-3[]","storage":"encounter","interpret":true,"font":"customfonts:determination"}]
execute scheduled 11t run scoreboard players set #battle battleActive 1
execute scheduled 11t run scoreboard players set #boss battleActive 1
