...
scoreboard players set #fleefromtoriel data 1

execute scheduled 1.5s run function boss:endfight

execute scheduled 40 run tp @s -832.0 47.0 51.5 0 0
execute scheduled 40 run scoreboard players set #canmove cutscene 0
execute scheduled 42 run scoreboard players set #canmove cutscene 0
execute scheduled 46 run scoreboard players set #canmove cutscene 0
execute scheduled 48 run scoreboard players set #canmove cutscene 0
execute scheduled 50 run function cutscene:ruins/18-toriel_fight/4/1