...
execute if score #canmove cutscene matches 2 run control player @s toggle action walking true
...
execute unless score #canmove cutscene matches 2 run control player @s toggle direction backward true
execute unless score #canmove cutscene matches 2 run control player @s toggle direction forward true
...
execute unless score #canmove cutscene matches 2 run control player @s toggle direction right true
