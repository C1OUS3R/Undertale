...
textBox display @s 14069002 [{"text": "* 'Hello!'","font":"customfonts:determination"}]

execute scheduled 10t if score @s interact matches 4 run textBox style 14069000 image texture minecraft:block/character/toriel/box/grin
