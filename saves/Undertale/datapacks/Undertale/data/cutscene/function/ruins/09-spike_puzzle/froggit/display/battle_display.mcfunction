...
execute if score @s lv matches 1 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv1
execute if score @s lv matches 2 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv2
execute if score @s lv matches 3 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv3
execute if score @s lv matches 4 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv4
execute if score @s lv matches 5 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv5
execute if score @s lv matches 6 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv6
execute if score @s lv matches 7 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv7
execute if score @s lv matches 8 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv8
execute if score @s lv matches 9 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv9
execute if score @s lv matches 10 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv10
execute if score @s lv matches 11 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv11
execute if score @s lv matches 12 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv12
execute if score @s lv matches 13 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv13
execute if score @s lv matches 14 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv14
execute if score @s lv matches 15 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv15
execute if score @s lv matches 16 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv16
execute if score @s lv matches 17 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv17
execute if score @s lv matches 18 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv18
execute if score @s lv matches 19 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv19
execute if score @s lv matches 20 run function cutscene:ruins/09-spike_puzzle/froggit/display/lv20
...
execute if score @s stage matches 1 run function cutscene:ruins/09-spike_puzzle/froggit/display/ifstage1
execute if score @s stage matches 2 run function cutscene:ruins/09-spike_puzzle/froggit/display/ifstage2
execute if score @s stage matches 3 run function cutscene:ruins/09-spike_puzzle/froggit/display/ifstage3
execute if score @s stage matches 4.. run function cutscene:ruins/09-spike_puzzle/froggit/display/ifstage4
...
execute if score @s attackSlider matches 138 run function cutscene:ruins/09-spike_puzzle/froggit/attacks/player/miss
...
execute if score @s sliderEnabled matches -6 run function cutscene:ruins/09-spike_puzzle/froggit/display/enemy_health
...
execute if entity @s[scores={inv=-1}] positioned ~ ~2 ~ if entity @e[type=minecraft:snowball,distance=..5,tag=attack] run execute positioned ~ ~-2 ~ run function cutscene:ruins/09-spike_puzzle/froggit/attacks/take_damage
execute positioned ~ ~2 ~ if entity @e[type=minecraft:snowball,distance=..5,tag=heal] run execute positioned ~ ~-2 ~ run function cutscene:ruins/09-spike_puzzle/froggit/attacks/heal
...
execute as @e[tag=bounce,tag=attack66] at @s if score #canleave atk matches 0 if score #box atk matches 1 unless entityarea 27.4 30 -56.4 20.6 40 -63.4 one @s run function cutscene:ruins/09-spike_puzzle/froggit/attacks/ruins/vegetoid/bounce/boing

execute as @e[tag=attack] if score #canleave atk matches -1 if score #box atk matches 1 unless entityarea 27.6 30 -57.4 20.4 40 -63.6 one @s run execute as @p at @s run function cutscene:ruins/09-spike_puzzle/froggit/attacks/end
