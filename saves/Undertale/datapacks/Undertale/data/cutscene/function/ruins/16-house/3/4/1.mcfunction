...
textBox display @s 13069002 [{"text": "* Oh, hello!","font":"customfonts:determination"}]

execute scheduled 10t if score #house3 cutscene matches 1 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/grin

execute scheduled 10t if score #house3 cutscene matches 1 run scoreboard players set @s canProgress 1
