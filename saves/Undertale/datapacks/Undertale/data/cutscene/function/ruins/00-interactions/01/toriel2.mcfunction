...
textBox display @s 13069002 [{"translate": "interaction-ruins-1.3","font":"customfonts:determination"}]
...
execute if data storage data {voices:1} scheduled 1t run sound play @s atTarget 6 minecraft:dialogue.cutscene0.2 voice 2 1 false 0 false