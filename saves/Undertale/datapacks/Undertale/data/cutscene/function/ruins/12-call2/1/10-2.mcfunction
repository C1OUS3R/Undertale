...
textBox display @s 13069002 [{"text": "* Is it Cinnamon?\n\n  Yes         No","font":"customfonts:determination"}]
...
execute if data storage data {voices:1} scheduled 1t run sound play @s atTarget 6 minecraft:dialogue.cutscene12.7 voice 2 1 false 0 false
