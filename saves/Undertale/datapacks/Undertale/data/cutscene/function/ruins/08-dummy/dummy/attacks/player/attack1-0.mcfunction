...
execute scheduled 13t run item replace entity @n[type=minecraft:item_display,tag=enemy1] container.0 with minecraft:netherite_block[minecraft:custom_model_data=90092]
execute scheduled 15t run model entity @n[type=minecraft:item_display,tag=enemy1] container.0 animation play damage
execute scheduled 25t run model entity @n[type=minecraft:item_display,tag=enemy1] container.0 animation stop
...
function cutscene:ruins/08-dummy/dummy/attacks/player/attack_health_calc
...
execute if score @n[type=armor_stand,tag=enemy1] hp matches ..0 scheduled 49t run function cutscene:ruins/08-dummy/dummy/kill
...
execute if score #battle enemyCount matches 1 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 scheduled 65t run function cutscene:ruins/08-dummy/dummy/win

execute if score @n[type=armor_stand,tag=enemy,scores={hp=1..}] hp matches 1.. scheduled 50t run function cutscene:ruins/08-dummy/dummy/attacks/select