...
scoreboard players set #torielfight cutscene 1
...
execute scheduled 35t if score #torielfight cutscene matches 1 run textBox style 14069000 image texture minecraft:block/character/toriel/box/mad

execute scheduled 35t if score #torielfight cutscene matches 1 run scoreboard players set @s canProgress 1

sound modify @s atTarget 6 volume 0
execute if data storage data {voices:1} scheduled 1t run sound play @s atTarget 6 minecraft:dialogue.cutscene18.1 voice 2 1 false 0 false
