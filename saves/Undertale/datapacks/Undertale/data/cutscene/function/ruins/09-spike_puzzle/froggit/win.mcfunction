...
item replace entity @n[type=item_display,tag=FFToriel] container.0 with netherite_block[custom_model_data=90079,utility:utility_animation={current_animation: "idle", start_time: 44373318L}]
