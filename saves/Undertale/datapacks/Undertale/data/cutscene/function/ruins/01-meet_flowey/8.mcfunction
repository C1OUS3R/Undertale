...
scoreboard players set #01-meet-flowey cutscene 8
...
execute scheduled 45 run execute if score #01-meet-flowey cutscene matches 8 run textBox style 14069000 image texture minecraft:block/character/flowey/box/smile
...
execute scheduled 4 run sound play @s atTarget 4 minecraft:block.cherry_leaves.break block 2 1 false 0 false