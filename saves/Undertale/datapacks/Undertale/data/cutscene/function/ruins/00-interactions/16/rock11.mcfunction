...
scoreboard players set #rockpuzzle4 data 4
...
execute scheduled 6t as @n[type=item_display,tag=Rock4] at @s run tp @s ~.15 ~ ~
execute scheduled 6t run scoreboard players set @s canProgress 1

execute scheduled 1t run sound play @a atTarget 3 minecraft:block.stone_button.click_off block 1 1 false 0 false
execute scheduled 4t run setblock -501 56 -45 minecraft:stone_pressure_plate[powered=false]
execute scheduled 1t run clone -509 50 -44 -506 52 -42 -509 55 -44
execute scheduled 1t run sound play @a atTarget 3 minecraft:block.piston.extend block 1 1 false 0 false
execute scheduled 1t run shakeCamera @a .1 2
