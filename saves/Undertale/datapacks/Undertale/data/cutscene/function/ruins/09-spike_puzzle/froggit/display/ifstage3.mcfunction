...
execute if score @s stage matches 3 if score @s selected matches 3 if score @s leftPressed matches 1.. if score @s itemPage matches 2 if score @s selected3 matches 1..2 run function cutscene:ruins/09-spike_puzzle/froggit/display/item
execute if score @s stage matches 3 if score @s selected matches 3 if score @s rightPressed matches 1.. if score @s itemPage matches 1 if score @s selected3 matches 3..4 if score @s itemCount matches 5.. run function cutscene:ruins/09-spike_puzzle/froggit/display/item2
...
execute if score @s stage matches 3 if score @s selected matches 1 if score @s continue matches 1.. if score @s sliderEnabled matches 1 if score @s selected2 matches 1 if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/attacks/player/attack1-0
execute if score @s stage matches 3 if score @s selected matches 1 if score @s continue matches 1.. if score @s sliderEnabled matches 1 if score @s selected2 matches 2 if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/attacks/player/attack2-0
execute if score @s stage matches 3 if score @s selected matches 1 if score @s continue matches 1.. if score @s sliderEnabled matches 1 if score @s selected2 matches 3 if entity @n[type=armor_stand,tag=enemy3,scores={hp=1..}] scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/attacks/player/attack3-0

#act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 1 if score @n[type=armor_stand,tag=enemy1] actText1 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 2 if score @n[type=armor_stand,tag=enemy1] actText2 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 3 if score @n[type=armor_stand,tag=enemy1] actText3 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 4 if score @n[type=armor_stand,tag=enemy1] actText4 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act

execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 1 if score @n[type=armor_stand,tag=enemy2] actText1 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 2 if score @n[type=armor_stand,tag=enemy2] actText2 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 3 if score @n[type=armor_stand,tag=enemy2] actText3 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 4 if score @n[type=armor_stand,tag=enemy2] actText4 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act

execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 1 if score @n[type=armor_stand,tag=enemy3] actText1 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 2 if score @n[type=armor_stand,tag=enemy3] actText2 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 3 if score @n[type=armor_stand,tag=enemy3] actText3 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 4 if score @n[type=armor_stand,tag=enemy3] actText4 matches 1 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/act

#skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 1 if score @n[type=armor_stand,tag=enemy1] actText1 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 2 if score @n[type=armor_stand,tag=enemy1] actText2 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 3 if score @n[type=armor_stand,tag=enemy1] actText3 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 1 if score @s selected3 matches 4 if score @n[type=armor_stand,tag=enemy1] actText4 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact

execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 1 if score @n[type=armor_stand,tag=enemy2] actText1 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 2 if score @n[type=armor_stand,tag=enemy2] actText2 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 3 if score @n[type=armor_stand,tag=enemy2] actText3 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 2 if score @s selected3 matches 4 if score @n[type=armor_stand,tag=enemy2] actText4 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact

execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 1 if score @n[type=armor_stand,tag=enemy3] actText1 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 2 if score @n[type=armor_stand,tag=enemy3] actText2 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 3 if score @n[type=armor_stand,tag=enemy3] actText3 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact
execute if score @s stage matches 3 if score @s selected matches 2 if score @s continue matches 1.. if score @s selected2 matches 3 if score @s selected3 matches 4 if score @n[type=armor_stand,tag=enemy3] actText4 matches 0 scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/skipact

#
execute if score @s stage matches 3 if score @s selected matches 4 if score @s selected3 matches 1 if score @s continue matches 1.. scheduled 1t run execute if score #battle win matches 0 run function cutscene:ruins/09-spike_puzzle/froggit/attacks/select

execute if score @s stage matches 3 if score @s selected matches 3 if score @s continue matches 1.. scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/useitem

execute if score #battle canflee matches 1 if score @s stage matches 3 if score @s selected matches 4 if score @s selected3 matches 2 if score @s continue matches 1.. scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/flee

execute if score @s stage matches 3 if score @s selected matches 1..2 if score @s goBack matches 1.. scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/stage2
execute if score @s stage matches 3 if score @s selected matches 3..4 if score @s goBack matches 1.. scheduled 1t run function cutscene:ruins/09-spike_puzzle/froggit/display/stage1
