...
textBox display @s 14069003 [{"text": "* (The snoring stops.)","font":"customfonts:determination"}]
...
execute scheduled 5t if score @s interact matches 9 run scoreboard players set @s canProgress 1