...
scoreboard players set #house3 data 4
...
textBox display @s 13069002 [{"text": "* It is called\n  \"72 Uses for Snails.\"","font":"customfonts:determination"}]

execute scheduled 42t if score #house3 cutscene matches 3 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/grin

execute scheduled 42t if score #house3 cutscene matches 3 run scoreboard players set @s canProgress 1
