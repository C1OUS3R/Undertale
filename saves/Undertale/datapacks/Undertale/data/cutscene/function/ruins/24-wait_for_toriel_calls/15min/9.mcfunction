...
textBox display @s 14069003 [{"text": "* Come back here with my\n  CELLPHONE!","font":"customfonts:determination"}]
...
execute scheduled 30t if score @s interact matches 9 run scoreboard players set @s canProgress 1