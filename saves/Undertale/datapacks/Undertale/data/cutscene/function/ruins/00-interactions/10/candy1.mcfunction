...
textBox display @s 13069003 [{"translate": "interaction-ruins-10.1","font":"customfonts:determination"}]
...
execute scheduled 14t if score @s interact matches 11 if score @s selected matches 1 run textBox style 14263006 image offset 28 -15.5
execute scheduled 14t if score @s interact matches 11 if score @s selected matches 2 run textBox style 14263006 image offset 87 -15.5
