...
textBox display @s 13069002 [{"text": "* For no reason in\n  particular...\n* Which do you prefer?","font":"customfonts:determination"}]
...
execute if data storage data {voices:1} scheduled 1t run sound play @s atTarget 6 minecraft:dialogue.cutscene12.2 voice 2 1 false 0 false