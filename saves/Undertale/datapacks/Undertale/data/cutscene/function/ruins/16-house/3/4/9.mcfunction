...
textBox display @s 13069002 [{"text": "* Well, bother me\n  if you need anything\n  else.","font":"customfonts:determination"}]

execute scheduled 40t if score #house3 cutscene matches 9 run scoreboard players set @s canProgress 1

execute scheduled 40t if score #house3 cutscene matches 3 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/grin
