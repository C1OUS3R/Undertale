...
textBox display @s 14069003 [{"text": "* ... if you return my CELLPHONE.","font":"customfonts:determination"}]
...
execute scheduled 15t if score @s interact matches 10 run scoreboard players set @s canProgress 1