...
textBox display @s 13069003 [{"text": "* Leave 7G in the web?\n\n         Yes        No","font":"customfonts:determination"}]
...
execute scheduled 9t if score @s interact matches 3 run textBox display @s 14263006 ""
execute scheduled 9t if score @s interact matches 3 run textBox style 14263006 image texture minecraft:block/battle/heart
execute scheduled 9t if score @s interact matches 3 if score @s selected matches 1 run textBox style 14263006 image offset 28 -15.5
execute scheduled 9t if score @s interact matches 3 if score @s selected matches 2 run textBox style 14263006 image offset 87 -15.5
