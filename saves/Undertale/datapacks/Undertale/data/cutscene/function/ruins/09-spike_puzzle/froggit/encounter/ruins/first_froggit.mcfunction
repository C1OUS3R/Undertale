...
scoreboard players set #battle id 17
function cutscene:ruins/09-spike_puzzle/froggit/transition
...
data modify storage encounter Display1-1 append value '{"text": "* Froggit attacks you!"}'
...
data modify storage encounter Display2-1 append value '{"text": "* Froggit attacks you!"}'
...
data modify storage encounter Display3-1 append value '{"text": "* Froggit attacks you!"}'
...
data modify storage encounter Display4-1 append value '{"text": "* Froggit attacks you!"}'
...
data modify storage encounter Display5-1 append value '{"text": "* Froggit attacks you!"}'
...
data modify storage encounter Display8-1 append value '{"text": "* Froggit attacks you!"}'
...
function cutscene:ruins/09-spike_puzzle/froggit/enemy_type/store_data