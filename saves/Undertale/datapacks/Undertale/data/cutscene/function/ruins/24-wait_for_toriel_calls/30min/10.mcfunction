...
textBox display @s 14069003 [{"text": "* Oh dear...","font":"customfonts:determination"}]
...
execute scheduled 4t if score @s interact matches 10 run scoreboard players set @s canProgress 1