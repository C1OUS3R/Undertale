...
execute scheduled 10t run function cutscene:ruins/09-spike_puzzle/froggit/attacks/player/attack_health_calc
...
execute scheduled 11t run function cutscene:ruins/09-spike_puzzle/froggit/display/enemy_health
...
execute scheduled 11t run scoreboard players set #battle battleActive 4
