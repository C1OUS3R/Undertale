...
textBox display @s 507 ""

textBox display @s 501 {"translate": "intro.5","font":"customfonts:determination"}
...
execute scheduled 120 if score @s introcutscene matches 2..3 run function cutscene:intro/play/4
