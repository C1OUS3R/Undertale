...
textBox display @s 509 ""

textBox display @s 520 {"translate": "intro.8","font":"customfonts:determination"}
...
execute scheduled 120 if score @s introcutscene matches 2..3 run function cutscene:intro/play/7
