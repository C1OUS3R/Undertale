...
execute scheduled 11t run scoreboard players set @s selected 0
...
execute scheduled 11t run scoreboard players set #battle battleActive 1
...
execute scheduled 11t as @a at @s run scoreboard players set @s stage 666
...
execute scheduled 11t as @a at @s run control player @s toggle direction forward true
execute scheduled 11t as @a at @s run control player @s toggle direction backward true
...
execute scheduled 11t as @a at @s run sound stop @s atTarget id 9
execute scheduled 13t run sound play @s atTarget 9 minecraft:music.000 music .3 1 true
...
textBox style 585700020 image texture minecraft:block/battle/fight
textBox style 585700020 text color #ff7f27
textBox style 585700020 box border on #ff7f27
textBox style 585700020 image color #ff7f27
textBox style 585700021 image texture minecraft:block/battle/act
textBox style 585700021 text color #ff7f27
textBox style 585700021 box border on #ff7f27
textBox style 585700021 image color #ff7f27
textBox style 585700022 image texture minecraft:block/battle/item
textBox style 585700022 text color #ff7f27
textBox style 585700022 box border on #ff7f27
textBox style 585700022 image color #ff7f27
textBox style 585700023 image texture minecraft:block/battle/mercy
textBox style 585700023 text color #ff7f27
textBox style 585700023 box border on #ff7f27
textBox style 585700023 image color #ff7f27

execute unless score @s itemCount matches 1.. unless score @s selected matches 3 run textBox style 585700022 image color dark_gray
execute unless score @s itemCount matches 1.. run textBox style 585700022 image color dark_gray
