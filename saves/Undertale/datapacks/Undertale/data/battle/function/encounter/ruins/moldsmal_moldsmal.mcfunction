...
scoreboard players set #battle id 7
...
data modify storage encounter Display1-1 append value '{"text": "* Moldsmal and Moldsmal"}'
data modify storage encounter Display1-2 append value '{"text": "  block the way."}'
