...
scoreboard players set #battle id 15
...
data modify storage encounter Display1-1 append value '{"text": "* Vegetoid and Migosp attacked!"}'
...
data modify storage encounter Display2-1 append value '{"text": "* Vegetoid cackles softly."}'
...
data modify storage encounter Display3-1 append value '{"text": "* Vegetoid\'s here for your health."}'
...
data modify storage encounter Display5-1 append value '{"text": "* It smells like steamed"}'
data modify storage encounter Display5-2 append value '{"text": "  carrots and peas."}'
...
data modify storage encounter Display11-1 append value '{"text": "* Vegetoid seems kind of bruised."}'
...
data modify storage encounter Display12-1 append value '{"text": "* Vegetoid seems kind of bruised."}'
