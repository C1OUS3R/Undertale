...
textBox display @s 695700212 ""
textBox style 695700212 image texture minecraft:block/battle/blank

execute scheduled 1t run textBox style 695700212 image texture minecraft:block/battle/knife_1
execute scheduled 3t run textBox style 695700212 image texture minecraft:block/battle/knife_2
execute scheduled 6t run textBox style 695700212 image texture minecraft:block/battle/knife_3
execute scheduled 9t run textBox style 695700212 image texture minecraft:block/battle/knife_4
execute scheduled 12t run textBox style 695700212 image texture minecraft:block/battle/knife_5
execute scheduled 15t run textBox style 695700212 image texture minecraft:block/battle/knife_6
execute scheduled 18t run textBox hide @s 695700212
...
execute scheduled 15t run model entity @n[type=minecraft:item_display,tag=enemy2] container.0 animation play damage
execute scheduled 25t run model entity @n[type=minecraft:item_display,tag=enemy2] container.0 animation play loop
...
scoreboard players operation @s attackValue -= @n[type=armor_stand,tag=enemy2] def
...
scoreboard players operation @n[type=armor_stand,tag=enemy2] displayHealth = @n[type=armor_stand,tag=enemy2] hp
scoreboard players operation @n[type=armor_stand,tag=enemy2] hp -= @s attackValue

function battle:attacks/player/attack_health_calc

execute scheduled 15t run textBox display @s 695700211 {"score": {"name": "@s","objective": "attackValue"},"font": "customfonts:damage","color": "#ff0000"}
execute scheduled 14t run textBox style 695700211 text shakeStrength 1
execute scheduled 21t run textBox style 695700211 text shakeStrength 0
execute scheduled 45t run textBox hide @s 695700211

execute scheduled 15t run scoreboard players set @s sliderEnabled -6

execute scheduled 15t run textBox display @s 695700213 ""
execute scheduled 15t run textBox display @s 695700214 ""
execute scheduled 50t run textBox hide @s 695700213
execute scheduled 50t run textBox hide @s 695700214


execute if score @n[type=armor_stand,tag=enemy2] hp matches ..0 scheduled 49t run function battle:kill
