...
execute if score @s stage matches 1 run function battle:display/ifstage1
execute if score @s stage matches 2 run function battle:display/ifstage2
execute if score @s stage matches 3 run function battle:display/ifstage3
...
execute if score @s attackSlider matches 138 run function battle:attacks/player/miss
...
execute if score @s sliderEnabled matches -6 run function battle:display/enemy_health
...
execute if entity @s[scores={inv=-1}] positioned ~ ~2 ~ if entity @e[type=minecraft:snowball,distance=..5,tag=attack] run execute positioned ~ ~-2 ~ run function battle:attacks/take_damage
execute positioned ~ ~2 ~ if entity @e[type=minecraft:snowball,distance=..5,tag=heal] run execute positioned ~ ~-2 ~ run function battle:attacks/heal
...
execute as @e[tag=bounce,tag=attack66] at @s if score #canleave atk matches 0 if score #box atk matches 1 unless entityarea 27.4 30 -56.4 20.6 40 -63.4 one @s run function battle:attacks/ruins/vegetoid/bounce/boing
