...
function battle:display/enemy_health
...
execute unless score @s spareNameColor matches 2..3 run function battle:display/stage2yellow
execute if score @s spareNameColor matches 2 run function battle:display/stage2white
execute if score @s spareNameColor matches 3 run function battle:display/stage2pink
