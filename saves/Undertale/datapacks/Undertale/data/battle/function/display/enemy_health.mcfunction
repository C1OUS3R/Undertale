...
execute if score @n[type=armor_stand,tag=enemy1] displayHealth matches 30.. run textBox style 695700114 box margin right 30
...
execute if score @n[type=armor_stand,tag=enemy2] displayHealth matches 30.. run textBox style 695700214 box margin right 30
...
execute if score @n[type=armor_stand,tag=enemy3] displayHealth matches 30.. run textBox style 695700314 box margin right 30
...
execute if score @n[type=armor_stand,tag=enemy1] renderHealth matches 30.. run textBox style 695700116 box margin right 30
...
execute if score @n[type=armor_stand,tag=enemy2] renderHealth matches 30.. run textBox style 695700216 box margin right 30
...
execute if score @n[type=armor_stand,tag=enemy3] renderHealth matches 30.. run textBox style 695700316 box margin right 30