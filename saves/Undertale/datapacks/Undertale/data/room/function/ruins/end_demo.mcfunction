...
scoreboard players set #canmove cutscene 2
control player @s toggle action walking false
rotate @s head 0 0
control player @s force forward true
execute scheduled 1 run control player @s force forward true
execute scheduled 3 run control player @s force forward true

execute scheduled 2 run control player @s toggle direction forward false
execute scheduled 2 run control player @s toggle direction backward false
execute scheduled 2 run control player @s toggle direction right false
execute scheduled 2 run control player @s toggle direction left false
...
execute scheduled 2 run scoreboard players set #canmove cutscene 2
