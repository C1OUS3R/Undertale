...
execute scheduled 7t run tp @s -204.0 47.0 -45.05 0 0
...
kill @e[type=item_display,tag=Torielsc]
kill @e[type=item_display,tag=torielow1]
kill @e[type=item_display,tag=floweycs1]
execute as @e[tag=spawntoriel] scheduled 7 run kill @s