...
execute scheduled 10t run execute scheduled 7t run scoreboard players set @s room 15

#set position & camera
execute scheduled 10t run execute scheduled 7t run camera player @s interpolation 0 true
execute scheduled 10t run execute scheduled 7t run tp @s ~14 62.5 ~52 0 0
...
scoreboard players add #fallenonpuzzle data 1
