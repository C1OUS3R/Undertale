...
execute if score @s canAdd matches 8 run scoreboard players set @s inv8 1
execute if score @s canAdd matches 7 run scoreboard players set @s inv7 1
execute if score @s canAdd matches 6 run scoreboard players set @s inv6 1
execute if score @s canAdd matches 5 run scoreboard players set @s inv5 1
execute if score @s canAdd matches 4 run scoreboard players set @s inv4 1
execute if score @s canAdd matches 3 run scoreboard players set @s inv3 1
execute if score @s canAdd matches 2 run scoreboard players set @s inv2 1
execute if score @s canAdd matches 1 run scoreboard players set @s inv1 1