...
execute if score @s canAdd matches 8 run scoreboard players set @s inv8 6
execute if score @s canAdd matches 7 run scoreboard players set @s inv7 6
execute if score @s canAdd matches 6 run scoreboard players set @s inv6 6
execute if score @s canAdd matches 5 run scoreboard players set @s inv5 6
execute if score @s canAdd matches 4 run scoreboard players set @s inv4 6
execute if score @s canAdd matches 3 run scoreboard players set @s inv3 6
execute if score @s canAdd matches 2 run scoreboard players set @s inv2 6
execute if score @s canAdd matches 1 run scoreboard players set @s inv1 6