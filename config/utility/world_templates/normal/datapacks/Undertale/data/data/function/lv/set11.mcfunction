...
scoreboard players set @a lv 11
scoreboard players set @a maxHealth 60

scoreboard players set @a atk 30
scoreboard players set @a def 12
scoreboard players set @a neededExp 2500
scoreboard players set @a levelup 1
execute scheduled 1s run scoreboard players reset @a levelup

scoreboard players set @a playerBaseAttack 20
