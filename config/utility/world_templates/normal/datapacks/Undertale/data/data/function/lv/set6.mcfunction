...
scoreboard players set @a lv 6
scoreboard players set @a maxHealth 40

scoreboard players set @a atk 20
scoreboard players set @a def 11
scoreboard players set @a neededExp 300
scoreboard players set @a levelup 1
execute scheduled 1s run scoreboard players reset @a levelup

scoreboard players set @a playerBaseAttack 10
