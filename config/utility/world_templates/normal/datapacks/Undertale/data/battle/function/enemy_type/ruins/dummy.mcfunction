...
execute if entity @s[tag=enemy2] run data modify storage enemy2 EnemyName append value '{"text":"Dummy"}'
execute if entity @s[tag=enemy3] run data modify storage enemy3 EnemyName append value '{"text":"Dummy"}'
...
scoreboard players set @s runAwayAt 99999
...
data modify storage encounter act3-2 append value '* It doesn\'t seem much for conversation.'
data modify storage encounter act3-3 append value '* TORIEL seems happy with you.'
