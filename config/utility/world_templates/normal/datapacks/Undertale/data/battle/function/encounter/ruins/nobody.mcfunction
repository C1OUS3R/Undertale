...
scoreboard players set #battle id 0
function battle:butnobodycame

### -values- ###
#enemy count (max 3)
scoreboard players set #battle enemyCount 0
...
data modify storage encounter Display1-1 append value '{"text": "* but nobody came."}'
...
data modify storage encounter Display2-1 append value '{"text": "* but nobody came."}'
...
data modify storage encounter Display3-1 append value '{"text": "* but nobody came."}'
...
data modify storage encounter Display4-1 append value '{"text": "* but nobody came."}'
...
data modify storage encounter Display5-1 append value '{"text": "* but nobody came."}'
...
data modify storage encounter Display8-1 append value '{"text": "* but nobody came."}'
...
data modify storage encounter Display11-1 append value '{"text": "* but nobody came."}'
