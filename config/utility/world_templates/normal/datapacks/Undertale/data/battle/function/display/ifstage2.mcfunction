...
execute if score @s forwardPressed matches 1.. if score @s selected2 matches 2..3 run scoreboard players remove @s selected2 1
execute if score #battle enemyCount matches 2 if score @n[type=armor_stand,tag=enemy1] hp matches 1.. if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @s backPressed matches 1.. if score @s selected2 matches 1..2 if score #battle enemyCount matches 2 run scoreboard players set @s selected2 2
execute if score @n[type=armor_stand,tag=enemy1] hp matches 1.. if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @n[type=armor_stand,tag=enemy3] hp matches 1.. if score @s backPressed matches 1.. if score @s selected2 matches 1..2 if score #battle enemyCount matches 3 run scoreboard players add @s selected2 1

execute if score #battle enemyCount matches 2..3 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 if score @s selected2 matches 1 run scoreboard players set @s selected2 2
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @s selected2 matches 1 run scoreboard players set @s selected2 2
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 if score @n[type=armor_stand,tag=enemy2] hp matches ..0 if score @s selected2 matches 2 run scoreboard players set @s selected2 3

execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @n[type=armor_stand,tag=enemy3] hp matches 1.. if score @s forwardPressed matches 1.. run scoreboard players set @s selected2 2
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches 1.. if score @n[type=armor_stand,tag=enemy2] hp matches ..0 if score @n[type=armor_stand,tag=enemy3] hp matches 1.. if score @s forwardPressed matches 1.. run scoreboard players set @s selected2 1
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches 1.. if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @n[type=armor_stand,tag=enemy3] hp matches ..0 if score @s forwardPressed matches 1.. run scoreboard players set @s selected2 1
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @n[type=armor_stand,tag=enemy3] hp matches 1.. if score @s backPressed matches 1.. run scoreboard players set @s selected2 3
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches 1.. if score @n[type=armor_stand,tag=enemy2] hp matches ..0 if score @n[type=armor_stand,tag=enemy3] hp matches 1.. if score @s backPressed matches 1.. run scoreboard players set @s selected2 3
execute if score #battle enemyCount matches 3 if score @n[type=armor_stand,tag=enemy1] hp matches 1.. if score @n[type=armor_stand,tag=enemy2] hp matches 1.. if score @n[type=armor_stand,tag=enemy3] hp matches ..0 if score @s backPressed matches 1.. run scoreboard players set @s selected2 2
...
execute if score @s stage matches 2 if score @s selected2 matches 1 if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score @s continue matches 1.. scheduled 1t run function battle:display/stage3
execute if score @s stage matches 2 if score @s selected2 matches 2 if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] if score @s continue matches 1.. scheduled 1t run function battle:display/stage3
execute if score @s stage matches 2 if score @s selected2 matches 3 if entity @n[type=armor_stand,tag=enemy3,scores={hp=1..}] if score @s continue matches 1.. scheduled 1t run function battle:display/stage3

execute if score @s stage matches 2 if score @s goBack matches 1.. scheduled 1t run function battle:display/stage1