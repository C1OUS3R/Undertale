...
execute if score #selectAttack math matches 1..3 run function battle:attacks/ruins/froggit/flies
execute if score #selectAttack math matches 4 run function battle:attacks/ruins/froggit/dots
execute if score #selectAttack math matches 5 run function battle:attacks/ruins/froggit/jump
...
execute if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] unless score #enemy2 act matches 2..3 if score #text2 math matches 1 run textBox display @s 695700200 "Ribbit,\nribbit."
execute if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] unless score #enemy2 act matches 2..3 if score #text2 math matches 2 run textBox display @s 695700200 "Croak,\ncroak."
execute if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] unless score #enemy2 act matches 2..3 if score #text2 math matches 3 run textBox display @s 695700200 "Hop,\nhop."
execute if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] unless score #enemy2 act matches 2..3 if score #text2 math matches 4 run textBox display @s 695700200 "Meow."

execute if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] if score #enemy2 act matches 2 run textBox display @s 695700200 "Shiver,\nshiver."
execute if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] if score #enemy2 act matches 3 run textBox display @s 695700200 "(Blushes\ndeeply.)\nRibbit.."
...
execute if score #enemy1 act matches 3 run scoreboard players set @n[type=armor_stand,tag=enemy1] spareable 1
execute if score #enemy2 act matches 3 run scoreboard players set @n[type=armor_stand,tag=enemy2] spareable 1