...
execute if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] unless score #enemy1 act matches 3..4 if score #text1 math matches 1 run textBox display @s 695700100 "Farmed\nLocally,\nVery\nLocally"
execute if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] unless score #enemy1 act matches 3..4 if score #text1 math matches 2 run textBox display @s 695700100 "Part Of\nA\nComplete\nBreakfast"
execute if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] unless score #enemy1 act matches 3..4 if score #text1 math matches 3 run textBox display @s 695700100 "Fresh\nMorning\nTaste"
execute if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] unless score #enemy1 act matches 3..4 if score #text1 math matches 4 run textBox display @s 695700100 "Contains\nVitamin\nA"

execute if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score #enemy1 act matches 3 run textBox display @s 695700100 "Plants\nCan't\nTalk\nDummy"
execute if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score #enemy1 act matches 4 run textBox display @s 695700100 "Eat\nYour\nGreens"
