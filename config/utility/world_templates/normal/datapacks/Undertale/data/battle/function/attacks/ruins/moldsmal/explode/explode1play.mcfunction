...
execute scheduled 50 run execute as @n[type=snowball,tag=attack1] at @s run execute if score #attackactive battleActive matches 1 run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 60 run execute as @n[type=snowball,tag=attack2] at @s run execute if score #attackactive battleActive matches 1 run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 80 run execute as @n[type=snowball,tag=attack3] at @s run execute if score #attackactive battleActive matches 1 run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 100 run execute as @n[type=snowball,tag=attack4] at @s run execute if score #attackactive battleActive matches 1 run function battle:attacks/ruins/moldsmal/explode/boom
