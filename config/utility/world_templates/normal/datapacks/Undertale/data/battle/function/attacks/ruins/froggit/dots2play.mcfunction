...
execute at @p run execute scheduled 41 run velocity @n[type=minecraft:snowball,tag=attack6] toPos ~ 35 ~ .3
...
execute scheduled 103 run execute at @p run velocity @n[type=minecraft:snowball,tag=attack9] toPos ~ 35 ~ .3
