...
scoreboard players set #battle id 2
...
data modify storage encounter Display1-1 append value '{"text": "* Froggit hopped close!"}'
...
data modify storage encounter Display12-1 append value '{"text": ""}'
