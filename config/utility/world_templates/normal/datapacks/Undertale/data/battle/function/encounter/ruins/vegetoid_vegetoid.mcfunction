...
scoreboard players set #battle id 13
...
data modify storage encounter Display1-1 append value '{"text": "* Vegetoid came out of the earth!"}'
...
data modify storage encounter Display4-1 append value '{"text": "* Vegetoid gave a mysterious smile."}'
