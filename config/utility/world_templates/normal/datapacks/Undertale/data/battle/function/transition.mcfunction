...
scoreboard players set @n[type=armor_stand,tag=enemy1] renderHealth 30
scoreboard players set @n[type=armor_stand,tag=enemy1] displayHealth 30

scoreboard players set @n[type=armor_stand,tag=enemy2] renderHealth 30
scoreboard players set @n[type=armor_stand,tag=enemy2] displayHealth 30

scoreboard players set @n[type=armor_stand,tag=enemy3] renderHealth 30
scoreboard players set @n[type=armor_stand,tag=enemy3] displayHealth 30
...
execute scheduled 13t run sound play @s atTarget 10 minecraft:music.009 music .3 1 true
