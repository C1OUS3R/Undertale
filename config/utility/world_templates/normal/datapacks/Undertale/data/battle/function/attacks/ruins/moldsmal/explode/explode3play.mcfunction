...
execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5004}},Tags:["attack","attack11","attack-.5","Moldsmal"]} 24.0 35 -58 180 0 .1 true

execute scheduled 20 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5004}},Tags:["attack","attack12","attack-.5","Moldsmal"]} 22.0 35 -58 180 0 .1 true

execute scheduled 48 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5004}},Tags:["attack","attack13","attack-.5","Moldsmal"]} 24.0 35 -58 180 0 .1 true

execute scheduled 70 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5004}},Tags:["attack","attack14","attack-.5","Moldsmal"]} 26.0 35 -58 180 0 .1 true

execute scheduled 88 run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5004}},Tags:["attack","attack15","attack-.5","Moldsmal"]} 23.0 35 -58 180 0 .1 true
...
execute scheduled 40 run execute as @n[type=snowball,tag=attack6] at @s run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 50 run execute as @n[type=snowball,tag=attack7] at @s run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 75 run execute as @n[type=snowball,tag=attack8] at @s run function battle:attacks/ruins/moldsmal/explode/boom
...
execute scheduled 45 run execute as @n[type=snowball,tag=attack12] at @s run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 55 run execute as @n[type=snowball,tag=attack13] at @s run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 85 run execute as @n[type=snowball,tag=attack14] at @s run function battle:attacks/ruins/moldsmal/explode/boom

execute scheduled 95 run execute as @n[type=snowball,tag=attack15] at @s run function battle:attacks/ruins/moldsmal/explode/boom
