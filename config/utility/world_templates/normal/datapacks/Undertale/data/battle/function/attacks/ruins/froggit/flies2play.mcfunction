...
execute scheduled 1.9s run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5001}},Tags:["attack","attack6","attack-.5","Froggit"]} 24 35 -58 0 0 0 true
execute scheduled 2.9s run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5001}},Tags:["attack","attack7","attack-.5","Froggit"]} 26 35 -58 0 0 0 true
execute scheduled 3.9s run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5001}},Tags:["attack","attack8","attack-.5","Froggit"]} 22 35 -58 0 0 0 true
execute scheduled 4.9s run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5001}},Tags:["attack","attack9","attack-.5","Froggit"]} 27 35 -58 0 0 0 true
execute scheduled 5.9s run execute if score #attackactive battleActive matches 1 run shoot minecraft:snowball {Item:{id:"minecraft:netherite_block",count:1,components:{"minecraft:custom_model_data":5001}},Tags:["attack","attack10","attack-.5","Froggit"]} 23 35 -58 0 0 0 true
#
...
execute at @p run execute scheduled 53 run velocity @n[type=minecraft:snowball,tag=attack6] toPos ~ 35 ~ .3
...
execute scheduled 83 run execute at @p run velocity @n[type=minecraft:snowball,tag=attack7] toPos ~ 35 ~ .3
...
execute scheduled 97 run execute at @p run velocity @n[type=minecraft:snowball,tag=attack8] toPos ~ 35 ~ .3
...
execute scheduled 115 run execute at @p run velocity @n[type=minecraft:snowball,tag=attack9] toPos ~ 35 ~ .3
...
execute scheduled 131 run execute at @p run velocity @n[type=minecraft:snowball,tag=attack10] toPos ~ 35 ~ .3
