...
scoreboard players set #03-meet-flowey cutscene 8
...
execute scheduled 45 run execute if score #03-meet-flowey cutscene matches 8 run textBox style 14069000 image texture minecraft:block/character/flowey/box/smile
