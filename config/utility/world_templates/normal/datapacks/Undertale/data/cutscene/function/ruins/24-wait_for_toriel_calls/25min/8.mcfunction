...
textBox display @s 14069003 [{"text": "* Oh dear, I should not keep\n  my guest waiting any longer.","font":"customfonts:determination"}]
...
execute scheduled 30t if score @s interact matches 8 run scoreboard players set @s canProgress 1