...
execute if score @s stage matches 2 if score @s selected2 matches 1 if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score @s continue matches 1.. scheduled 1t run function cutscene:ruins/08-dummy/dummy/display/stage3
execute if score @s stage matches 2 if score @s selected2 matches 2 if entity @n[type=armor_stand,tag=enemy2,scores={hp=1..}] if score @s continue matches 1.. scheduled 1t run function cutscene:ruins/08-dummy/dummy/display/stage3
execute if score @s stage matches 2 if score @s selected2 matches 3 if entity @n[type=armor_stand,tag=enemy3,scores={hp=1..}] if score @s continue matches 1.. scheduled 1t run function cutscene:ruins/08-dummy/dummy/display/stage3

execute if score @s stage matches 2 if score @s goBack matches 1.. scheduled 1t run function cutscene:ruins/08-dummy/dummy/display/stage1