...
scoreboard players set #rockpuzzle4 data 2
...
execute as @n[type=item_display,tag=Rock4] at @s run tp @s ~ ~ ~.1
execute scheduled 1t as @n[type=item_display,tag=Rock4] at @s run tp @s ~ ~ ~.1
execute scheduled 2t as @n[type=item_display,tag=Rock4] at @s run tp @s ~ ~ ~.1
