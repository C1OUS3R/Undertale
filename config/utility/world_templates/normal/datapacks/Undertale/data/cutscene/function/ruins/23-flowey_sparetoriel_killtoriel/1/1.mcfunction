...
scoreboard players set #spare_toriel_data data 1
...
execute scheduled 5 run execute scheduled 25 run execute if score #23-meet-flowey cutscene matches 1 run textBox style 14069000 image texture minecraft:block/character/flowey/box/sassy

execute scheduled 5 run execute scheduled 25 run execute if score #23-meet-flowey cutscene matches 1 run item replace entity @n[type=minecraft:item_display,tag=floweycs23] container.0 with minecraft:netherite_block[minecraft:custom_model_data=90062]

execute scheduled 5 run execute scheduled 25 run execute if score #23-meet-flowey cutscene matches 1 run scoreboard players set @s canProgress 1
