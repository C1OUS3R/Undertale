...
textBox display @s 13069002 [{"text": "* Perhaps you should\n  take a nap.\n  Yes         No","font":"customfonts:determination"}]
...
textBox hide @s 14263006
execute scheduled 35t if score #house3 cutscene matches 3 run textBox display @s 14263006 ""
execute scheduled 35t if score #house3 cutscene matches 3 run textBox style 14263006 image texture minecraft:block/battle/heart
execute scheduled 18t if score #house3 cutscene matches 3 if score @s selected matches 1 run textBox style 14263006 image offset 23 -15.5
execute scheduled 18t if score #house3 cutscene matches 3 if score @s selected matches 2 run textBox style 14263006 image offset 86 -15.5
