...
execute if score #battle id matches 4 if score #doesplay id matches 0 scheduled 1t run function cutscene:ruins/08-dummy/dummy/attacks/ruins/whimsun/spare
execute if score #battle id matches 5 if score #doesplay id matches 0 scheduled 1t run function cutscene:ruins/08-dummy/dummy/attacks/ruins/whimsun/spare

function cutscene:ruins/08-dummy/dummy/attacks/select