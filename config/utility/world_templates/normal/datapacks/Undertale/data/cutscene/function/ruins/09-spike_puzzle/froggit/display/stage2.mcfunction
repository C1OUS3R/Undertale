...
function cutscene:ruins/09-spike_puzzle/froggit/display/enemy_health
...
execute unless score @s spareNameColor matches 2..3 run function cutscene:ruins/09-spike_puzzle/froggit/display/stage2yellow
execute if score @s spareNameColor matches 2 run function cutscene:ruins/09-spike_puzzle/froggit/display/stage2white
execute if score @s spareNameColor matches 3 run function cutscene:ruins/09-spike_puzzle/froggit/display/stage2pink
