...
textBox display @s 14069003 [{"text": "* Helloooo?\n* Little puppy...?","font":"customfonts:determination"}]
...
execute scheduled 15t if score @s interact matches 6 run scoreboard players set @s canProgress 1