...
textBox display @s 14069002 [{"text": "* I have something\n  to show you\n  upstairs.","font":"customfonts:determination"}]
...
execute if data storage data {voices:1} scheduled 1t run sound play @s atTarget 6 minecraft:dialogue.cutscene17.19 voice 2 1 false 0 false