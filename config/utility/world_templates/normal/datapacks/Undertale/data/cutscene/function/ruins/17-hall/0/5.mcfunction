...
scoreboard players set #hallstage data 3
...
textBox display @s 14069002 [{"text": "* It is drafty here.\n* You will catch\n  a cold.","font":"customfonts:determination"}]
...
execute if data storage data {voices:1} scheduled 1t run sound play @s atTarget 6 minecraft:dialogue.cutscene17.22 voice 2 1 false 0 false