...
textBox display @s 14069003 [{"text": "* I do wonder how they are...","font":"customfonts:determination"}]
...
execute scheduled 8t if score @s interact matches 11 run scoreboard players set @s canProgress 1