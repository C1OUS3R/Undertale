...
textBox display @s 14069003 [{"text": "* Perhaps they have been calling\n  the phone, and...?","font":"customfonts:determination"}]
...
execute scheduled 30t if score @s interact matches 10 run scoreboard players set @s canProgress 1