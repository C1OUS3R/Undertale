...
textBox display @s 13069003 [{"translate": "interaction-ruins-10.6","font":"customfonts:determination"}]
sound play @s atTarget 3 minecraft:sfx.item block 1 1 false 0 false

function data:inv/add/1
scoreboard players set #candy data 4
item replace entity @n[tag=candy] container.0 with netherite_block[custom_model_data=12]
