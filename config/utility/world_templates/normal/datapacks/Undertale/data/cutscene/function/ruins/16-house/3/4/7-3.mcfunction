...
textBox display @s 13069002 [{"text": "* Make terrible\n  shoelaces?","font":"customfonts:determination"}]

execute scheduled 25t if score #house3 cutscene matches 7 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/grin

execute scheduled 25t if score #house3 cutscene matches 7 run scoreboard players set @s canProgress 1
