...
textBox display @s 14069002 [{"text": "* My apologies.","font":"customfonts:determination"}]

execute scheduled 15t if score @s interact matches 4 run textBox style 14069000 image texture minecraft:block/character/toriel/box/smile
