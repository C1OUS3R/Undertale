...
execute if score @n[type=armor_stand,tag=enemy,scores={hp=1..}] hp matches 1.. scheduled 10t run function cutscene:ruins/09-spike_puzzle/froggit/attacks/select