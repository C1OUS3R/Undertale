...
execute as @n[type=armor_stand,tag=enemy1] at @s if score @s hp matches -99999..0 run item replace entity @n[type=item_display,tag=enemy1] container.0 with netherite_block[custom_model_data=90094]


scoreboard players set #dummy data 2
kill @n[type=item_display,tag=dummyow]
...
scoreboard players set #dummykilled data 1