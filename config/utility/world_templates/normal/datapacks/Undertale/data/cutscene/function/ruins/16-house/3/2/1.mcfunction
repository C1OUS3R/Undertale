...
scoreboard players set #house3 data 2
...
textBox display @s 13069002 [{"text": "* You'd rather stay\n  up and chat with\n  me, then?","font":"customfonts:determination"}]

execute scheduled 55t if score #house3 cutscene matches 1 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/look

execute scheduled 55t if score #house3 cutscene matches 1 run scoreboard players set @s canProgress 1
