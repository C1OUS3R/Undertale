...
textBox display @s 13069002 [{"text": "* Here is an exciting\n  snail fact.","font":"customfonts:determination"}]

execute scheduled 40t if score #house3 cutscene matches 5 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/grin

execute scheduled 40t if score #house3 cutscene matches 5 run scoreboard players set @s canProgress 1
