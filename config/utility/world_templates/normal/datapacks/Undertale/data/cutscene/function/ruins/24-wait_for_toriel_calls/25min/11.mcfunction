...
textBox display @s 14069003 [{"text": "* ... here, puppy!","font":"customfonts:determination"}]
...
execute scheduled 10t if score @s interact matches 11 run scoreboard players set @s canProgress 1