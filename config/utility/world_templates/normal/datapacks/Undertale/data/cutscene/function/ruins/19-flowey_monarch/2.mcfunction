...
scoreboard players set #19-meet-flowey cutscene 2
...
execute scheduled 44 run execute if score #19-meet-flowey cutscene matches 2 run textBox style 14069000 image texture minecraft:block/character/flowey/box/sassy
execute scheduled 44 run execute if score #19-meet-flowey cutscene matches 2 run item replace entity @n[type=minecraft:item_display,tag=floweycs19] container.0 with minecraft:netherite_block[minecraft:custom_model_data=90062]

execute scheduled 44 run execute if score #19-meet-flowey cutscene matches 2 run scoreboard players set @s canProgress 1
