...
#sound play @s atTarget 10 minecraft:music.014 music .7 1 true 0 false 10.08

function boss:encounter/ruins/toriel
...
scoreboard players set #torielfight data 2

execute scheduled 1s run clone -864 46 38 -853 50 47 -838 46 50