...
scoreboard players set #house3 data 1
...
textBox display @s 13069002 [{"text": "* Hello there,\n  little one!","font":"customfonts:determination"}]

execute scheduled 26t if score #house3 cutscene matches 1 run textBox style 13069000 image texture minecraft:block/character/toriel/box/glasses/grin

execute scheduled 26t if score #house3 cutscene matches 1 run scoreboard players set @s canProgress 1
