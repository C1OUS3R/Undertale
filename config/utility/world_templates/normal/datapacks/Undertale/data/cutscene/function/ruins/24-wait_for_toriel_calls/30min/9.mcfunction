...
textBox display @s 14069003 [{"text": "* Doggie...\n* Here, doggie...","font":"customfonts:determination"}]
...
execute scheduled 8t if score @s interact matches 9 run scoreboard players set @s canProgress 1