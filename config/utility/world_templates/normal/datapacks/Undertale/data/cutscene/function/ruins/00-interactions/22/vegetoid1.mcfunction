...
scoreboard players set #vegetoid1 data 1
model entity @e[type=minecraft:item_display,tag=vegetoid1] container.0 animation play popout
...
execute scheduled 25t run kill @e[type=minecraft:item_display,tag=vegetoid1]