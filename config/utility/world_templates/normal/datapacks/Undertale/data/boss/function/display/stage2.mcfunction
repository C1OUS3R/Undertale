...
function boss:display/enemy_health
...
execute unless score @s spareNameColor matches 2..3 run function boss:display/stage2yellow
execute if score @s spareNameColor matches 2 run function boss:display/stage2white
execute if score @s spareNameColor matches 3 run function boss:display/stage2pink
