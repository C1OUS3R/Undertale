...
execute if score #boss id matches 2 scheduled 15t run sound play @s atTarget 3 minecraft:sfx.hitenemy block .5 1 false
execute if score #boss id matches 2 if score #battle enemyCount matches 1 scheduled 15t if score @n[type=armor_stand,tag=enemy1] hp matches ..0 run sound stop @s atTarget id 10
#execute scheduled 20t run sound play @s atPos ~ ~22 ~ -5 minecraft:sfx.hurt_enemy block 2 1 false

execute if score #boss id matches 2 unless score @s kills matches 20.. unless score #torielsparestatus data matches 14.. scheduled 13t if score @n[type=armor_stand,tag=enemy1] hp matches ..0 run item replace entity @n[type=minecraft:item_display,tag=enemy1] container.0 with minecraft:netherite_block[minecraft:custom_model_data=90086,utility:utility_animation={current_animation: "idle", start_time: 44373318L}]
execute if score #boss id matches 2 if score @s kills matches 20.. scheduled 13t if score @n[type=armor_stand,tag=enemy1] hp matches ..0 run item replace entity @n[type=minecraft:item_display,tag=enemy1] container.0 with minecraft:netherite_block[minecraft:custom_model_data=90087,utility:utility_animation={current_animation: "idle", start_time: 44373318L}]
execute if score #boss id matches 2 if score #torielsparestatus data matches 14.. scheduled 13t if score @n[type=armor_stand,tag=enemy1] hp matches ..0 run item replace entity @n[type=minecraft:item_display,tag=enemy1] container.0 with minecraft:netherite_block[minecraft:custom_model_data=90087,utility:utility_animation={current_animation: "idle", start_time: 44373318L}]
execute if score #boss id matches 2 scheduled 15t run model entity @n[type=minecraft:item_display,tag=enemy1] container.0 animation play damaged
execute if score #boss id matches 2 scheduled 25t unless score @n[type=armor_stand,tag=enemy1] hp matches ..0 run model entity @n[type=minecraft:item_display,tag=enemy1] container.0 animation play idle
execute if score #boss id matches 2 scheduled 30t if score @n[type=armor_stand,tag=enemy1] hp matches ..0 run model entity @n[type=minecraft:item_display,tag=enemy1] container.0 animation play fall
...
function boss:attacks/player/attack_health_calc
...
execute if score #boss id matches 2 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 scheduled 49t run function boss:attacks/end_toriel
execute if score @n[type=armor_stand,tag=enemy,scores={hp=1..}] hp matches 1.. scheduled 50t run function boss:attacks/select1
...
execute if score #boss id matches 1 if score #battle enemyCount matches 1 if score @n[type=armor_stand,tag=enemy1] hp matches ..0 scheduled 65t run function boss:attacks/end_napstablook

execute if score #boss id matches 1 if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score #napstablookcheer data matches 3 run execute as @n[type=armor_stand,tag=enemy1] at @s run scoreboard players set @s actText4 1
execute if score #boss id matches 1 if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score #napstablookcheer data matches 3 run scoreboard players set #enemy1 act 2
execute if score #boss id matches 1 if entity @n[type=armor_stand,tag=enemy1,scores={hp=1..}] if score #napstablookcheer data matches 3 run scoreboard players set #napstablookcheer data -1